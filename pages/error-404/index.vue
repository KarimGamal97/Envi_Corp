<template>
    ...
    >
        ...
        <h1
            class="font-poppins text-[35px] leading-[44px] sm:text-[46px] sm:leading-[52px] md:text-heading-1 font-extrabold mb-7"
        >
            Whoops! That page doesn’t exist.
        </h1>
        <h4 class="font-bold font-poppins text-[14px] xl:text-heading-5 text-gray-500 mb-[70px]">
