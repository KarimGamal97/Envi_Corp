<template>
  <div class="full-width bg-bg-7">
    ...
    >
      <div
        class="flex-1 absolute bottom-0 right-0 max-w-[667px] aspect-[667/600]"
      >
        <img
      ...
      <div class="flex-1 max-w-[667px]">
        ...
        <p class="text-quote md:text-lead-lg text-gray-600 mb-[50px]">
          With our expertise and comprehensive documentation services, we ensure
          that you remain compliant with environmental regulations while
          striving to create a greener and more sustainable future.
        </p>
        <div class="md:mt-[90px]">
          ...
          >
            ...
            <div>
              <h3
                class="font-bold font-chivo text-[20px] leading-[26px] md:text-heading-4 mb-[14px]"
              >
