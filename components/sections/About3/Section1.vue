<template>
  <div class="px-[12px] md:px-[36px] xl:px-0 mt-[70px] text-center">
    <div class="text-center mb-[35px] md:mb-[43px]">
      ...
      <p
        class="text-quote md:text-lead-lg text-gray-600 mx-auto max-w-[976px]"
      ></p>
    </div>
    <h3
      class="font-bold font-chivo text-[20px] leading-[26px] md:text-heading-4 text-gray-600 mx-auto mb-[40px] md:mb-[75px] md:w-[50ch]"
    >
      ENVI-COMM CORPORATION is an environmental consulting corporation composed
      of individuals passionate about sustainable development through compliance
      with various environmental regulations and the institutionalization of
      in-house environmental conservation and sustainable development programs
      and systems.
    </h3>
