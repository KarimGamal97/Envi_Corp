<template>
    <div class="px-[12px] md:px-[36px] xl:px-0 mt-[70px] text-center z-10 relative lg:mt-[99px]">
        <div class="text-center">
            <h2
                class="font-bold font-poppins mx-auto text-gray-900 mb-5 md:mb-[30px] text-[35px] leading-[44px] md:text-[46px] md:leading-[52px] lg:text-heading-1 md:w-[20ch]"
            >
        ...
        <div class="flex items-center justify-center mb-[87px]">
            ...
            <div class="flex items-center gap-3">
                ...
                <NuxtLink
                    class="text-base flex items-center font-poppins font-medium text-[18px] leading-[18px] gap-[5px]"
                    to="/"
