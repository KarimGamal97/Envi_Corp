<template>
    <div class="full-width bg-gray-100">
        <div class="text-center px-5 pt-[74px] pb-[90px]">
            <h1
                class="font-poppins font-bold lg:text-display-3 md:text-[45px] md:leading-[52px] text-[35px] leading-[42px] mb-7"
            >
                Shop: Electronic
            </h1>
            <p
                class="font-bold font-poppins text-[14px] md:text-heading-6 text-gray-600 mx-auto md:max-w-[55ch]"
            >
