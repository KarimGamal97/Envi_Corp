<template>
  <div
    class="px-[12px] md:px-[36px] xl:px-0 mt-[70px] text-center lg:mt-[50px]"
  >
    <span
      class="font-chivo inline-block bg-bg-6 text-green-900 py-[14px] px-[28px] rounded-[50px] text-[14px] leading-[14px] mb-[29px] md:mb-[43px]"
    ...
    <div class="text-center mb-[35px] md:mb-[50px]">
      ...
      >
        Clear Guidance. <span class="text-green-900">Green </span>Future.
      </h2>
    ...
    <div
      class="flex items-center justify-center gap-[22px] mb-[40px] md:mb-[70px]"
    >
      <button type="button">
        <NuxtLink
