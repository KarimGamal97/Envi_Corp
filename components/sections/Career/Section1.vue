<template>
    <div class="px-[12px] md:px-[36px] xl:px-0 mt-[70px] text-center lg:mt-[50px]">
        <span
            class="font-poppins inline-block bg-bg-6 text-green-900 py-[14px] px-[28px] rounded-[50px] text-[14px] leading-[14px] mb-[29px] md:mb-[43px]"
