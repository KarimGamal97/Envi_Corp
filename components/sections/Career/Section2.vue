    ...
    <div class="lg:flex lg:gap-5">
      ...
      >
        <div>
          ...
          />
          <h2
            class="font-bold font-chivo text-[28px] leading-[32px] md:text-heading-2 mb-[30px]"
          >
            Application
          </h2>
      ...
      >
        <div>
          ...
          <p class="text-excerpt text-gray-600 mb-[30px]">
            Navigating complex environmental regulations and processes to ensure
            your projects meet all compliance standards.
          </p>
        </div>
        <img
          class="absolute bottom-0 right-0 z-0 max-w-[90px] md:max-w-[144px] max-h-[90px] md:max-h-[144px] translate-x-[20%] translate-y-[20%] xl:translate-x-0 xl:translate-y-0"
      ...
      >
        <div>
          ...
          <p class="text-excerpt text-gray-600 mb-[30px]">
            Leveraging expertise to provide sustainable environmental solutions
