    ...
    <div class="full-width bg-orange-100">
        ...
        >
            <div class="flex-[1.36] mr-[90px]">
                ...
                <p class="text-quote md:text-lead-lg text-gray-600 mb-[55px]">
            ...
            <div class="flex flex-col gap-8 flex-1">
                ...
                >
                    <p class="text-text mb-[15px]">
                        &quot;No matter where you go, It's is the coolest, most happening thing
                ...
                >
                    <p class="text-text mb-[15px]">
                        &quot;Wow what great service, I love it! It's is the most valuable business
                        resource we have EVER purchased. We can't understand how we've been living
                        without it. I couldn't have asked for more than this.&quot;
                    </p>
                    <div class="flex items-center gap-6">
                        <img
                            class="h-full w-full object-cover rounded-full max-w-[80px]"
            ...
            <div class="flex flex-col gap-8 flex-1">
                ...
                >
                    <p class="text-text mb-[15px]">
                        ...
                        the perfect solution for our business. It has really helped our business.
                ...
                >
                    <p class="text-text mb-[15px]">
                        ...
                        been looking for. Definitely worth the investment.&quot;
                    </p>
                    <div class="flex items-center gap-6">
                        <img
                            class="h-full w-full object-cover rounded-full max-w-[80px]"
