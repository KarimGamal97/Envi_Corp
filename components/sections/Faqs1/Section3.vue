  ...
  <div class="gap-6 px-5 lg:flex xl:gap-[50px]">
    ...
    <div class="flex-[1.5]">
      <div class="relative accordion-item mb-5">
        <details>
          <summary
            class="flex justify-between py-5 items-center gap-5 px-[30px]"
          >
            <h4 class="font-bold font-chivo text-[14px] xl:text-heading-5">
              Where is my order? Quisque molestie
            </h4>
          </summary>
          <p class="text-text content font-chivo mt-[30px] ml-[30px]">
