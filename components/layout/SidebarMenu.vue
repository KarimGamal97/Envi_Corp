<template>
  <div
    ...
    class="burger-icon burger-icon-white menu__icon"
  >
  ...
  >
    <div
      class="flex items-center border-b p-[15px] lg:p-[26px] gap-[10px] border-[#F2F4F7]"
    >
      <img
        class="max-w-[50px]"
    ...
    <div class="p-[30px]">
      ...
      <div
        class="mt-5 border-t border-b border-gray-100 pb-5 mb-[25px] pt-[30px]"
      >
